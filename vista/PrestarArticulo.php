  ...
  <div class="starter-template">
    ...
    <div class="jumbotron">
      <div class="container text-center">
        ...
        <h2>Escoja el responsable</h2>
<a href="nuevoArticulo.php?id=6" class="btn btn-default btn-info"><span class="glyphicon glyphicon-plus"></span>Registrar nuevo Responsable</a>
<br><br>
        <form id="searchp" >
